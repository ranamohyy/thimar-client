...
class ProductDetailsView extends StatefulWidget {
   ProductDetailsView({super.key,
     ...
     this.afterDiscount,
     this.title,
     this.beforeDiscount,  this.isFav,
     this.categoryId,
...
class _ProductDetailsViewState extends State<ProductDetailsView> {
  final bloc = GetIt.I<ProductDetailsBloc>()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  const Icon(Icons.check_box, color: Color(
                                      0xff93bd62)),
                                  SizedBox(
                                    width: 10.w,),
                                  Text(
                            ...
                            Row(
                              children: [
                                AppImage(url: widget.image!, height: 65.h,
                                    width: 65.w),
                                SizedBox(
                                  width: 8.w,
                                ),
                                Column(
                                  children: [
                                    Text(widget.title!,
                                      style: kTextStyle14.copyWith(fontSize: 16,
        ...
        appBar: AppBar(
          ...
          backgroundColor: Colors.white,
          actions: [
            CustomFavButton(id: widget.id!, isFav: widget.isFav!,),
          ]
          ,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                      "${widget.beforeDiscount.toString()}ر.س",
                                      style: const TextStyle(
                                          fontFamily: kTextFamily,
                                  ...
                                  Text(
                                      "${widget.afterDiscount.toString()}ر.س",
                                      style: const TextStyle(
                                          fontFamily: kTextFamily,
                                          color: kPrimaryColor,
                                          decoration:
                              ...
                              Row(
                                children: [
                                   Text(
                                      "السعر / 1كجم",
                                      style: kTextStyle15light.copyWith(fontSize: 18)),
                              ...
                              Padding(
                                padding: EdgeInsets.only(top: 4.0.h,
                                    right: 8.w),
                                child: RateProductWidget(id: widget
                                    .categoryId!,),
                              ),
                              Text(
                                "عناصر مشابهه",
                             ...
                             const SizedBox(height: 8,),
                              SizedBox(
                                  ...
                                  child: SimilarItemsWidget(categoryId: widget
                                      .categoryId!,))
