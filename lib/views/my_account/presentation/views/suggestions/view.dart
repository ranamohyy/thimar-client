...
class _SuggestionsViewState extends State<SuggestionsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold
      (
      appBar:const CustomAppBar(text: "الأقتراحات والشكاوي" ),
          ...
          child: Column(
            ...
            TextFormField(
              ...
              border: OutlineInputBorder(
                ...
                borderSide: const BorderSide(color: kBorderColorField),
              )
            )),
    ...
    child:const Text("إرسال",style: kTextStyle14,));
