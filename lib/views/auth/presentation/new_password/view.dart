...
import 'package:thimar/views/auth/data/reset_password/bloc.dart';
...
class _ResetPasswordViewState extends State<ResetPasswordView> {
  ...
  Widget build(BuildContext context) {
    ...
    phone:widget.phone, code:widget.code, passsword: passwordController.text));
    },
    child:  Text("تغيير كلمة المرور", style: kTextStyle14,),
    );
    }    ),
